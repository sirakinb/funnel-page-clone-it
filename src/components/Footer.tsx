        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" className="text-white hover:text-gray-300">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm6.593 8.25l-7.289 3.821c-.203.108-.327.314-.327.54v7.158c0 .228.124.434.328.541l7.289 3.821c.4.21.857-.108.857-.541v-14.8c0-.433-.457-.751-.858-.54z"/>
                </svg>
              </a>
            </div>
          </div>
