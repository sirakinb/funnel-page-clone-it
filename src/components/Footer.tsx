    ...
    <footer className="bg-neutral-800 text-white">
      <div className="container-custom py-16">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">I'm excited for you to explore this guide!</h2>
          <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
            Start building your AI skills now so you're not left behind in a world where
