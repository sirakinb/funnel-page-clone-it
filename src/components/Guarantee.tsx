        ...
        <div className="flex flex-col md:flex-row items-center gap-6 border border-gray-200 rounded-lg p-6">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-2">
              If you don't get value from the playbook within 30 days, contact me and I'll refund you.
            </p>
            <p className="text-gray-600">
              All I ask is that you show me what you've tried and why it didn't work for you.
            </p>
          </div>
        </div>
      </div>
